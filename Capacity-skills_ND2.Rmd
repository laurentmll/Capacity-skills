...
# Suppression des individus qui ont répondu 'rdr' (ca en fait 10)
...
#View(skill[which(rownames(skill) %in% c(1805, 1783, 403, 2022, 1484, 554, 1068, 657, 1439, 1133, 1780)),])
#skill[which(rownames(skill)==410),]

# On supprime 12 individus dont les réponses contiennent beaucoup de 'nsp' ou 'comprend.pas' -> individus outliers 
#skill=skill[-which(rownames(skill) %in% c(1805, 1783, 403, 2022, 1484, 554, 1068, 657, 1439, 1133, 1780, 1794)),]
...
Si on veut étudier les premiers axes de l'AFM, on peut regarder principalement les 4 premiers axes.
